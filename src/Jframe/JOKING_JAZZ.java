...
public class JOKING_JAZZ extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(check, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkActionPerformed
            try {
                ...
                Logger.getLogger(JOKING_JAZZ.class.getName()).log(Level.SEVERE, null, ex);
            }
    }//GEN-LAST:event_checkActionPerformed
        
        public void read() throws FileNotFoundException, IOException{
        reservation rs = new reservation();
        File fi = new File("C:\\Users\\TUF GAMING\\Documents\\NetBeansProjects\\Seat_reservation\\src\\txt\\Joking_reservation.txt");
        FileReader fr = new FileReader(fi);
        BufferedReader br = new BufferedReader (fr);
        String s = "" ;
            while((s = br.readLine()) != null){
                String arr_s[] = s.split(",");
                int r = Integer.parseInt(arr_s[0]);
                int c = Integer.parseInt(arr_s[1]);
                disa(r, c);
        }
        br.close(); fr.close();
    }
    ...
    public void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JOKING_JAZZ().setVisible(true);
            }
        });
    }
