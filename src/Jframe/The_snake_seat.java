...
public class The_snake_seat extends javax.swing.JFrame {
    reservation rs = new reservation();

    public The_snake_seat() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Seat_text.setText("THE SANKEEEE");
    ...
    private void checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkActionPerformed
        try {
            ...
            Logger.getLogger(The_snake_seat.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_checkActionPerformed
        
        public void read() throws FileNotFoundException, IOException{
        //reservation rs = new reservation();
        File fi = new File("C:\\Users\\TUF GAMING\\Documents\\NetBeansProjects\\Seat_reservation\\src\\txt\\The_snake_reservation.txt");
    ...
    public void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new The_snake_seat().setVisible(true);
            }
        });
    }
