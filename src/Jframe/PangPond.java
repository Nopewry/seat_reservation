...
public class PangPond extends javax.swing.JFrame {
    ...
    private void homeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_homeActionPerformed
        home h = new home(); //if username and password are correct show seat reservation file
        h.show(); 
        dispose();
    ...
    private void checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkActionPerformed
            try {
                ...
                Logger.getLogger(PangPond.class.getName()).log(Level.SEVERE, null, ex);
            }
    }//GEN-LAST:event_checkActionPerformed
        
        
        public void read() throws FileNotFoundException, IOException{
        File fi = new File("C:\\Users\\TUF GAMING\\Documents\\NetBeansProjects\\Seat_reservation\\src\\txt\\Pangpond_reservation.txt");
